...
> **Note:** Dies ist eine übersetzte Version. Die englische `README.md` ist die maßgebliche Quelle.
...
Dieses Repository ist eine Full-Stack-Sandbox zum Aufbau eines **lokalen Retrieval-Augmented-Generation-(RAG)-Systems**.  
Das Backend ist ein FastAPI-Service mit Authentifizierung und RAG-API. Es verwendet **ChromaDB** als persistenten Vektorspeicher und **Ollama** sowohl für Embeddings als auch für Chat. Das Frontend ist eine Expo-/React-Native-App, die mit dem Backend kommuniziert.
...
- Frontend UI (mobile): exp://${YOUR_HOST}:8081: Zugriff über den von Expo bereitgestellten QR-Code.
